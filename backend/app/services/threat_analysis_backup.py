...
class ThreatAnalysisService:
    ...
    def _calculate_threat_score(
        ...
        if enhanced:
            if "enhanced_intel" in raw_responses:
                intel_data = raw_responses["enhanced_intel"]
                risk_score_adjustment = intel_data.get("risk_score_adjustment", 0)
                confidence_boost = intel_data.get("confidence_boost", 0)
                
                total_score += risk_score_adjustment
                confidence_factors.append(confidence_boost)
    ...
    async def _perform_deep_analysis(
        ...
        try:
            ...
            # Add deep analysis based on indicator
